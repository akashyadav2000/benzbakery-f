...
const PastryContainer = () => {
  ...
  return (
    <div
      className="pastry-background-color flexible-height min-h-fit lg:h-screen flex flex-col justify-center items-center overflow-hidden w-full max-w-[100vw] box-border"
    >
      <h1 className="text-center text-[21.5px] sm:text-[23px] md:text-[24px] lg:text-[26px] xl:text-[29px] pt-3 pb-[2px] md:pt-5 md:pb-3 text-[#ff0080ad] great-vibes tracking-wide">
        Our Most Popular
        <span className="pl-3 text-black tracking-widest">Pasty</span>
      </h1>
      <div
